...
.method public run()V
    ...
    iget-object v1, p0, Lcom/koushikdutta/ion/FileCacheStore$2;->val$parser:Lcom/koushikdutta/async/parser/AsyncParser;

    .line 109
    invoke-interface {v0, v1}, Lcom/koushikdutta/ion/builder/Builders$Any$B;->as(Lcom/koushikdutta/async/parser/AsyncParser;)Lcom/koushikdutta/ion/future/ResponseFuture;
    ...
    .line 110
    invoke-virtual {v1}, Lcom/koushikdutta/async/future/SimpleFuture;->getCompletionCallback()Lcom/koushikdutta/async/future/FutureCallback;
